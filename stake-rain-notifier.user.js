...
// @version      1.5.118
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.118 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle + Fix seuil min 1.01
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.118'; // Doit correspondre a @version
  ...
  function renderBetLog() {
    ...
    function exportXLSX() {
      if (typeof XLSX === 'undefined') {
        alert('SheetJS non chargé — réessaie dans quelques secondes.');
        return;
      }
