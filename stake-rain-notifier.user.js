...
'.srn-tick-down{color:#ff4444}',
        ...
        '<div class="srn-sec" id="tab-mystats">',
          '<div style="display:flex;gap:5px;margin-bottom:8px;justify-content:space-between;align-items:center">',
            ...
            '<div style="display:flex;align-items:center;gap:4px">',
              '<span style="color:#8899aa;font-size:11px">Objectif (USD) :</span>',
    ...
    el.innerHTML = [
      ...
      '<div class="srn-stat-card" style="margin-bottom:8px">',
        '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">',
          ...
          '<div style="display:flex;align-items:center;gap:4px">',
            '<input type="number" id="srn-period-goal-input" value="' + goalUsd + '" min="1" style="width:60px;background:#0f1923;border:1px solid #1e3a4a;border-radius:4px;color:#ffd700;padding:2px 5px;font-size:11px;font-weight:700;text-align:right" />',
      ...
      '<div id="srn-week-chart" style="position:relative">',
        ...
        '<div id="srn-week-tooltip" style="display:none;position:absolute;bottom:110%;left:50%;transform:translateX(-50%);background:#0f1923;border:1px solid #00d4ff44;border-radius:8px;padding:6px 10px;font-size:11px;color:#cdd9e5;white-space:nowrap;z-index:9999;pointer-events:none;box-shadow:0 4px 12px rgba(0,0,0,.6)"></div>',
      '</div>',
    ].join('');
  ...
  var CURRENT_VERSION = '1.5.42'; // Doit correspondre a @version
