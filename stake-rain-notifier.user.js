...
'.srn-tick-down{color:#ff4444}',
      ...
      '<div id="srn-body">',
        ...
        '<div class="srn-sec" id="tab-moderation">',
          ...
          '<div style="display:flex;gap:4px;margin-bottom:8px">',
            '<button class="srn-pbtn active" data-emojiperiod="day">Jour</button>',
            '<button class="srn-pbtn" data-emojiperiod="week">Semaine</button>',
            '<button class="srn-pbtn" data-emojiperiod="month">Mois</button>',
            '<button class="srn-pbtn" data-emojiperiod="alltime">All time</button>',
          '</div>',
  ...
  var CURRENT_VERSION = '1.5.62'; // Doit correspondre a @version
  ...
  function renderEmojiStats() {
    ...
    var now = Date.now();
    var since = 0;
    if (emojiPeriod === 'day')   since = now - 24 * 60 * 60 * 1000;
    if (emojiPeriod === 'week')  since = now - 7  * 24 * 60 * 60 * 1000;
    if (emojiPeriod === 'month') since = now - 30 * 24 * 60 * 60 * 1000;
