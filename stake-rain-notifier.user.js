...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.54'; // Doit correspondre a @version
  ...
  function renderEmojiStats() {
    ...
    var sorted = Object.entries(counts)
      ...
      .slice(0, 15);
    if (!sorted.length) {
      el.innerHTML = '<div class="srn-empty">Aucun emoji détecté pour le moment.</div>';
      return;
    }
    var max = sorted[0][1];
    ...
    el.innerHTML = sorted.map(function(e, idx) {
      ...
      return '<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;background:#162330;border:1px solid #1e3a4a;border-radius:8px;padding:6px 10px">'
        ...
        + '<img src="' + imgSrc + '" style="width:28px;height:28px;border-radius:4px;flex-shrink:0;object-fit:contain" onerror="this.style.display=&apos;none&apos;"/>'
        + '<div style="flex:1;min-width:0">'
          + '<div style="display:flex;align-items:center;gap:6px;margin-bottom:3px"><img src="' + imgSrc + '" style="width:22px;height:22px;object-fit:contain" onerror="this.style.display=&apos;none&apos;"/><span style="font-size:11px;color:#cdd9e5;font-weight:600">:' + name + ':</span></div>'
          ...
          + '</div>'
        + '</div>'
        + '<span style="color:' + rankColor + ';font-weight:800;font-size:13px;min-width:28px;text-align:right">' + count + '</span>'
        + '</div>';
    }).join('');
  }
