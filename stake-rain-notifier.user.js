...
// @version      1.5.96
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.96 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker
// @author       alleluiateam
...
(function () {
  ...
  function scanForBet(obj, parentObj) {
    ...
    save(SK_WAGER, wager);
    // Session tracker — reset si jeu différent
...
'.srn-tick-down{color:#ff4444}',
  ...
  // Session tracker — reset automatique au changement de jeu
  ...
  var CURRENT_VERSION = '1.5.96'; // Doit correspondre a @version
