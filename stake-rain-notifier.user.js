...
// @version      1.5.103
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.103 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle
// @author       alleluiateam
...
(function () {
  ...
  function scanForBet(obj, parentObj) {
    ...
    save(SK_WAGER, wager);
    // Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle — reset si jeu différent
...
'.srn-tick-down{color:#ff4444}',
  ...
  // Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle — reset automatique au changement de jeu
  ...
  function buildSetup() {
    ...
    panelEl.innerHTML = [
      ...
      '<div id="srn-body">',
        ...
        '<div id="srn-menu-dropdown">',
          ...
          '<div class="srn-menu-item" data-tab="multip"><div class="srn-menu-dot"></div>🎯 Mult Tracker</div>',
    ...
    var MENU_LABELS = {
      ...
      messages:'Messages', mystats:'Statistiques de rains', moderation:'Hot Words',
      rainers:'Top Rainer', wager:'Statistiques en direct', wagergoals:'\uD83C\uDFAF Wager Goals', multip:'Mult Tracker',
  ...
  var CURRENT_VERSION = '1.5.103'; // Doit correspondre a @version
    ...
    el.innerHTML = [
      ...
      '<div class="srn-stat-card" style="margin-bottom:10px">',
        ...
        '<div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">',
          ...
          '<input type="number" id="srn-multip-global" value="' + cfg.globalThreshold + '" min="2" max="100000" style="width:80px;background:#0f1923;border:1px solid #1e3a4a;border-radius:6px;color:#fff;padding:4px 8px;font-size:13px;font-weight:700" />',
