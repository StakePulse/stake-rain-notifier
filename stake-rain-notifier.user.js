...
'.srn-tick-down{color:#ff4444}',
  ...
  function buildSetup() {
    ...
    var MENU_LABELS = {
      ...
      messages:'🔔 Messages', mystats:'📊 Statistiques de rains', moderation:'🔥 Hot Words',
      rainers:'🏆 Top Rainer', wager:'📈 Statistiques en direct', multip:'Multiplicateur',
  ...
  var CURRENT_VERSION = '1.5.67'; // Doit correspondre a @version
    ...
    el.innerHTML = [
      ...
      '<div style="display:flex;flex-direction:column;gap:5px;margin-bottom:8px">',
        ...
        '<div style="display:flex;gap:5px">',
          '<input type="number" id="srn-multip-game-thresh" placeholder="x?" min="2" value="50" style="flex:1;background:#162330;border:1px solid #1e3a4a;border-radius:6px;color:#ffd700;padding:4px 8px;font-size:11px;font-weight:700" />',
