...
// @version      1.5.91
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.91 - Ajout menu Wager Goals
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  function buildSetup() {
    ...
    var MENU_LABELS = {
      ...
      messages:'Messages', mystats:'Statistiques de rains', moderation:'Hot Words',
      rainers:'Top Rainer', wager:'Statistiques en direct', multip:'Mult Tracker',
  ...
  var CURRENT_VERSION = '1.5.91'; // Doit correspondre a @version
