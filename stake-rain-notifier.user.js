...
(function () {
  ...
  function scanForBet(obj, parentObj) {
    ...
    var BET_TYPENAMES = ['CasinoBet', 'MultiplayerCrashBet', 'SportsBet', 'SlotBet', 'OriginalBet', 'ThirdPartyBet'];
    // Doit etre un type de bet connu
    if (obj.__typename && BET_TYPENAMES.indexOf(obj.__typename) < 0) return;
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.81'; // Doit correspondre a @version
