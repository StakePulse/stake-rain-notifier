...
// @version      1.5.128
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.128 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle + Fix seuil min 1.01
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  function refreshPanel() {
    ...
    // ── Meilleure rain 24h ──────────────────────────────────────────────────
    var since24h = now - 24 * 3600 * 1000;
    var rains24h = logFiltered.filter(function(e) { return e.ts >= since24h; });
  ...
  var CURRENT_VERSION = '1.5.128'; // Doit correspondre a @version
