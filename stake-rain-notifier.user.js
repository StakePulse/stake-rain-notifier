...
// @version      1.5.95
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.95 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode
// @author       alleluiateam
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.95'; // Doit correspondre a @version
