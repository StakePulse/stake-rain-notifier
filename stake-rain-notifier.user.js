...
(function () {
  ...
  var LANGS = {
    fr: {
      ...
      stats:            'Stats', ranking: 'Classement', history: 'Historique',
    ...
    en: {
      ...
      stats:            'Stats', ranking: 'Ranking', history: 'History',
...
'.srn-tick-down{color:#ff4444}',
  ...
  function renderHistory() {
    ...
    function renderEntries(entries) {
      ...
      el.innerHTML = entries.map(function(e) {
        ...
        if (usdVal) amtStr = '- <span style="color:#00d4ff">' + formatAmountInCurrency(usdVal, curPrefH) + '/joueur</span>';
  ...
  var CURRENT_VERSION = '1.5.49'; // Doit correspondre a @version
