...
// @version      1.5.102
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.5.102 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs
// @author       alleluiateam
...
(function () {
  ...
  function scanForBet(obj, parentObj) {
    ...
    save(SK_WAGER, wager);
    // Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs — reset si jeu différent
...
'.srn-tick-down{color:#ff4444}',
  ...
  // Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs — reset automatique au changement de jeu
  ...
  var CURRENT_VERSION = '1.5.102'; // Doit correspondre a @version
