...
'#srn-panel.light input,#srn-panel.light select,#srn-panel.light textarea{background:#fff;border-color:#dde3ea;color:#1a2332}',
...
'.srn-tick-down{color:#ff4444}',
  ...
  function buildSetup() {
    ...
    panelEl.innerHTML = [
      '<div id="srn-hdr">',
        '<span>🌧️ StakePulse <span style="font-size:9px;color:#8899aa;margin-left:4px">by alleluiateam</span> <span id="srn-notif-badge" style="display:none;background:#ff4444;color:#fff;border-radius:999px;font-size:10px;padding:1px 6px;margin-left:4px;font-weight:700;vertical-align:middle"></span></span>',
        '<div style="display:flex;align-items:center;gap:6px">',
          '<button id="srn-theme" title="Changer le theme" style="background:none;border:none;cursor:pointer;font-size:14px;padding:0 4px;color:#8899aa">☀️</button>',
          '<span class="srn-badge" style="background:#00ff8818;color:#00ff88;border-color:#00ff8844;font-size:10px;padding:2px 8px;white-space:nowrap">● LIVE</span>',
          '<button id="srn-tog" style="background:none;border:none;color:#8899aa;cursor:pointer;font-size:14px;padding:0 4px">−</button>',
        '</div>',
      '</div>',
      ...
      '</div>',
      '<div id="srn-body">',
        '<button id="srn-menu-btn"><span id="srn-menu-label">📋 Stats</span><span style="margin-left:auto">▾</span></button>',
  ...
  var CURRENT_VERSION = '1.5.76'; // Doit correspondre a @version
  ...
  function showUpdateBanner(newVersion) {
    ...
    banner.style.cssText = 'background:#00ff8810;border:1px solid #00ff8833;border-radius:10px;padding:10px 14px;margin-bottom:10px;display:flex;align-items:center;justify-content:space-between;gap:10px';
