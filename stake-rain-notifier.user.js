...
(function () {
  ...
  function observeChat() {
    ...
    function attachObserver() {
      var chatContainer = document.querySelector('[class*="chat-container"],[class*="chatroom"],[class*="chat-messages"],[class*="messages-list"],[data-testid*="chat"]');
      if (chatContainer) {
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.33'; // Doit correspondre a @version
