    ...
    var observer = new MutationObserver(function(mutations) {
      mutations.forEach(function(mutation) {
        mutation.addedNodes.forEach(function(node) {
          ...
          // Mentions et rains détectées via WebSocket (sender fiable)
          // Le DOM sert uniquement pour les emojis et le wordcount
          trackEmojis(node);
          trackWordCount(text, sender);
        });
      });
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.5.32'; // Doit correspondre a @version
