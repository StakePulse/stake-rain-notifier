...
'.srn-tick-down{color:#ff4444}',
  ...
  function buildSetup() {
    ...
    panelEl.innerHTML = [
      '<div id="srn-hdr">',
        '<span style="display:flex;align-items:center;gap:6px">🌧️ StakePulse <span style="font-size:9px;color:#8899aa;font-weight:400">by alleluiateam</span> <span id="srn-notif-badge" style="display:none;background:#ff4444;color:#fff;border-radius:999px;font-size:9px;padding:1px 5px;font-weight:700;cursor:pointer"></span></span>',
  ...
  var CURRENT_VERSION = '1.5.78'; // Doit correspondre a @version
