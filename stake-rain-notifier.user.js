...
'.srn-tick-down{color:#ff4444}',
    ...
    panelEl.innerHTML = [
      ...
      '<div id="srn-body">',
        ...
        '<div class="srn-sec" id="tab-settings">',
          ...
          '<div class="srn-cfg-r" style="align-items:flex-start;flex-direction:column;gap:4px"><label style="margin-bottom:4px">Chat surveillé</label><select id="cfg-chat-pref" style="width:100%;background:#162330;border:1px solid #1e3a4a;border-radius:6px;color:#fff;padding:5px 8px;font-size:12px">' + CHAT_OPTIONS.map(function(c) { return '<option value="' + c.id + '">' + c.label + '</option>'; }).join('') + '</select></div>',
          ...
          '<div id="srn-reset-confirm" style="display:none;margin-top:8px;padding:8px;border:1px solid #ff444433;border-radius:8px;text-align:center">',
            ...
            '</div>',
          '</div>',
          '<button class="srn-btn p" style="margin-top:5px" data-srn="tagExistingData">&#127991; Taguer donnees existantes avec le chat actuel</button>',
  ...
  var CURRENT_VERSION = '1.5.71'; // Doit correspondre a @version
