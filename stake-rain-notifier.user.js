...
'.srn-tick-down{color:#ff4444}',
  ...
  function renderMyStats() {
    ...
    // Convertir l'objectif en devise actuelle
    ...
    el.innerHTML = [
      ...
      '<div class="srn-stat-card">',
        ...
        '<div style="color:#8899aa;font-size:10px">Objectif : ' + parseFloat(WEEKLY_GOAL_DYN).toFixed(2) + symM + ' - Reste : ' + Math.max(0, WEEKLY_GOAL_DYN - weekTotal).toFixed(2) + symM + '</div>',
      '</div>',
  ...
  var CURRENT_VERSION = '1.5.40'; // Doit correspondre a @version
