...
'.srn-tick-down{color:#ff4444}',
    ...
    panelEl.innerHTML = [
      '<div id="srn-hdr">',
        ...
        '<div style="display:flex;align-items:center;gap:6px">',
          ...
          '<span class="srn-badge" style="background:#00ff8818;color:#00ff88;border-color:#00ff8844;font-size:10px;padding:2px 8px">● EN DIRECT</span>',
  ...
  var CURRENT_VERSION = '1.5.75'; // Doit correspondre a @version
