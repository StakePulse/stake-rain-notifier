...
// @version      1.7.14
// @description  StakePulse - Rain & Stats tracker pour Stake.bet - by alleluiateam | v1.7.14 - Ajout menu Wager Goals + Detecteur High Roller + Fix reset wager + Reset par periode + Session tracker + Migration wager goals + Fix Hot Words jour + Fix Emoji Stats jour + Filtre chats Hot Words + Fix Top Rainer jour + Fix Multi Tracker betId + notifs + Fix toggle + Fix seuil min 1.01
// @author       alleluiateam
...
(function () {
  ...
  function scanForBet(obj, parentObj) {
    ...
    if (wager.length > 10000) wager = wager.slice(-10000);
    save(SK_WAGER, wager);
...
'.srn-tick-down{color:#ff4444}',
  ...
  var CURRENT_VERSION = '1.7.14'; // Doit correspondre a @version
